      ...
      {points < 6 && (
        <div className={styles.container}>
          ...
          <main className={styles.main}>
            {questionPointer <= 5 && (
              <>
                <h1 className={[styles.title, displayHeadingClass].join(" ")}>
                  Welcome{" "}
                  <a href="https://www.urbandictionary.com/define.php?term=Cute">
                    Stupido
                  </a>
                </h1>
            ...
            {questionPointer <= 5 && (
              <div
                className={[styles.imageContainer, displaySubClass].join(" ")}
              >
                <h2 className={styles.titleh2}>
                  Score <span>{maxPoints}</span> points because{" "}
                </h2>
                <Image
            ...
            {points < 6 && (
              <h3 className={[styles.heading3, displayPointsClass].join(" ")}>
            ...
            <div className={displayQuizClass}>
              {questionPointer <= 5 && (
                <Quiz
                  questionData={data[questionPointer]}
            ...
            {questionPointer > 5 && (
              <Result points={points} resetGame={resetGame} />
            )}
          </main>
